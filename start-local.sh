...
# 本地局域网开发环境启动脚本
# 适用于局域网内开发，使用 IP: 192.168.1.118

set -e

echo "=========================================="
echo "  切换到本地局域网开发环境"
echo "  本机IP: 192.168.1.118"
echo "=========================================="
...
sed -i 's|^FRONTEND_URL=.*|FRONTEND_URL=http://192.168.1.118:5173,http://192.168.1.118:8080|g' backend/.env
...
echo ""
echo -e "${GREEN}✓ 配置文件已更新为本地局域网模式${NC}"
echo ""
echo "=========================================="
echo "  配置摘要："
echo "  • 后端API: http://192.168.1.118:3000"
echo "  • 管理后台: http://192.168.1.118:5173"
...
echo "  2. 使用 ./restart-backend.sh 重启后端服务"
echo "  3. 使用 ./restart-admin.sh 重启管理后台"
echo "  4. 在微信开发者工具中重新编译小程序"
echo "  5. 局域网内其他设备访问: http://192.168.1.118:5173"
echo ""
